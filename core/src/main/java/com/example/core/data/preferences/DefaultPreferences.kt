...
class DefaultPreferences(
    ...
    override fun saveGender(gender: Gender) {
        sharedPref.edit()
            .putString(Preferences.KEY_GENDER, gender.toString())
            .apply()
    }
    ...
    override fun saveActivityLevel(level: ActivityLevel) {
        sharedPref.edit()
            .putString(Preferences.KEY_ACTIVITY_LEVEL, level.toString())
            .apply()
    }

    override fun saveGoalType(goalType: GoalType) {
        sharedPref.edit()
            .putString(Preferences.KEY_GOAL_TYPE, goalType.toString())
            .apply()
    }
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        return UserInfo(
            gender = Gender.fromString(genderString ?: Gender.Male.toString()),
            age = age,
            weight = weight,
            height = height,
            activityLevel = ActivityLevel.fromString(
                activityLevelString ?: ActivityLevel.Medium.toString()
            ),
            goalType = GoalType.fromString(goalTypeString ?: GoalType.KeepWeight.toString()),
            carbRatio = carbRatio,
